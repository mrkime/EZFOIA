...
const Features = () => {
  return (
    <section id="features" className="py-24 bg-section-alt dark:bg-background relative overflow-hidden">
      {/* Subtle background pattern */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary/10 dark:bg-primary/10 rounded-full blur-3xl" />
